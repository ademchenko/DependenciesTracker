...
xcopy /Y DependenciesTracker.Interfaces\bin\Release\DependenciesTracking.Interfaces.dll NuGetPackaging\DependenciesTracker.Interfaces\lib\portable-net45+netcore45+wp8+MonoAndroid1+MonoTouch1\*
xcopy /Y DependenciesTracking.Interfaces.Net40\bin\Release\DependenciesTracking.Interfaces.dll NuGetPackaging\DependenciesTracker.Interfaces\lib\net40\*
